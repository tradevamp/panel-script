...
<head>
    ...
    <title><?php echo $page_title ?> - ExGuild CHECKER</title>
    ...
    <style>
        body {
            background-image: url("https://wallpapers.com/images/high/axolotl-3d-drawing-za6dzzzxvw7egif9.webp");
        }
                ...
                <div style="z-index: 5 !important; " class="card login-box-container">
                    <div class="card-body">
                        ...
                        <div style="margin-top: 30px;" class="authent-text">
                            <p> <span style="font-size: 20px;">ExGuild CHECKER</span> 'a Hoşgeldiniz!</p>
