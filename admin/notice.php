...
if (isset($_POST['icerik'])) {
    ...
    if ($uzunluk > "120") {
        $error = '120 Karakterden fazla giremezsiniz!';
    }
    ...
    if ($rowcount >= "5") {
        $error2 = '5 DUYURUDAN FAZLA GİREMEZSİN!';
    } else {
...
if (isset($error)) {
    ...
    if (isset($error2)) {
        ...
        if (isset($success)) {
            ...
            $success2 = 'Duyuru içeriği giriniz.';
        }
    }
}
...
<div class="row">
    <div class="col-xl-12 col-md-6">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4"><img style="width: 30px;height: auto;" src="/assets/images/notice.png" alt="">&nbsp;DUYURU PANELİ</h4>
                    <br>
                    <div class="block-content tab-content">
                        ...
                        <div class="table-responsive">
                            ...
                            <table id="zero-conf" class="table table-hover" style="width:100%">
								...
								<td>' . $getvar['d_time'] . '</td>
								<td><a href="editnotice/' . $getvar['id'] . '"><button type="button" class="btn btn-outline-danger">Düzenle</button></a></td>
