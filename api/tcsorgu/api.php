...
if (!isset($_POST["tc"])) {
    die(json_encode(array("success" => "false", "message" => "param errorr")));
}
...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, "http://141.98.1.168/wizort/api/hsys/tcsorgu.php?" . $query);
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
$response = curl_exec($ch);
curl_close($ch);
echo $response;

wizortbook($sorguURL, "Sorgu Denetleyicisi", "TC Sorgu", "**$kadi** isimli üye **$tc** için sorgu yaptı!");
