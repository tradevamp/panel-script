<?php
error_reporting(0);
$title =  htmlspecialchars($_GET['alert']);
if ($title == 'access') {
  $alert = '403';
  $title = '<h2>Erişim yok!</h2>';
  $caption = '<p>Bu tehlikeli bölgeye girişin yasaklanmıştır!
  Burası ürpertici bir yere benziyor, eve dönmek için aşağıdaki butona tıkla!
</p>';
}

if (empty($title)) {
  $alert = '404';
  $title = '<h2>Sanırım kaybolduk?</h2>';
  $caption = '<p>Bir şeylerin yanlış olduğunu düşünüyoruz.  
  Burası ürpertici bir yere benziyor, eve dönmek için aşağıdaki butona tıkla!
</p>';
}
...
<head>
  <meta charset="UTF-8">
  <title><?php echo $alert ?> - Volly</title>
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/normalize/5.0.0/normalize.min.css">
  <link rel='stylesheet' href='https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.1.3/css/bootstrap.min.css'>
  <link rel="stylesheet" href="/assets/plugins/404/404.css">
...
<body>
  <main>
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 align-self-center">
        <h2>Sanırım kaybolduk?</h2>
        <p>Bir şeylerin yanlış olduğunu düşünüyoruz.
          Burası ürpertici bir yere benziyor, eve dönmek için aşağıdaki butona tıkla!
        </p>
        <a href="/" class="btn btn-danger">Eve dön!</a>
        </div>
      </div>
    </div>
  </main>
  ...
  <script src="/assets/plugins/404/404.js"></script>
